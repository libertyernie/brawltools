    ...
    class SettingsDialog : Form
    {
        ...
        private void SettingsDialog_Shown(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem i in listView1.Items)
            {
                ...
                _updating = true;
                chkUpdatesOnStartup.Checked = Properties.Settings.Default.CheckUpdatesAtStartup;
                chkShowPropDesc.Checked = Properties.Settings.Default.DisplayPropertyDescriptionWhenAvailable;
                _updating = false;
                btnApply.Enabled = false;      
        }
